...
alter table public.product_settings add column if not exists boleto_validity_days integer;
...
create policy "clone anon sales write" on public.sales for all to anon using (true) with check (true);
